...
const pneumatologyContent: PneumatologyContent = {
  ...
  works: [
    ...
    },
    {
      ...
      description: "The Spirit's work in equipping for service",
      examples: [
        "Spiritual gifts",
  ...
  resources: [
    {
      ...
      url: "/resources/holy-spirit-ferguson",
      type: "Book",
      description: "Comprehensive Reformed perspective on the Holy Spirit.",
      affiliate: true,
      affiliateUrl: "https://amazon.com/dp/0830815618"
    },
    {
      title: "God the Holy Spirit",
      author: "Donald G. Bloesch",
      url: "/resources/god-holy-spirit-bloesch",
      type: "Book",
      description: "Evangelical theology of the Holy Spirit.",
      affiliate: true,
      affiliateUrl: "https://amazon.com/dp/0830815618"
    },
    {
      ...
      author: "Yves Congar",
      url: "/resources/holy-spirit-church-congar",
      type: "Book",
      description: "Catholic perspective on Spirit and ecclesiology.",
      affiliate: true,
      affiliateUrl: "https://amazon.com/dp/0824512347"
    }
  ]
}
...
export default function PneumatologyPage() {
  return (
    <div className="container mx-auto px-4 py-8 space-y-12">
      ...
      <section className="space-y-6">
        <h2 className="text-3xl font-bold mb-4">Theological Traditions</h2>
      ...
      <section className="space-y-6">
        <h2 className="text-3xl font-bold mb-4">Works of the Holy Spirit</h2>
        <div className="grid gap-6 md:grid-cols-2">
          {pneumatologyContent.works.map((work, index) => (
            <Card key={index}>
              ...
              <CardContent>
                ...
                <p className="mt-4 text-sm text-slate-600">{work.scriptureRef}</p>
              </CardContent>
            </Card>
          ))}
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <Link href="/christianity/theology/christology" className="block">
            <Card className="hover:bg-slate-50 transition-colors">
              ...
              <CardContent>
                <p>Explore the relationship between Christ and the Spirit.</p>
              </CardContent>
            </Card>
          </Link>
          <Link href="/christianity/theology/soteriology" className="block">
            <Card className="hover:bg-slate-50 transition-colors">
              ...
              <CardContent>
                <p>Understand the Spirit's role in salvation.</p>
              </CardContent>
            </Card>
          </Link>
          <Link href="/christianity/theology/ecclesiology" className="block">
            <Card className="hover:bg-slate-50 transition-colors">
              <CardHeader>
