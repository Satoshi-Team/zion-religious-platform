...
const ecclesiologyContent: EcclesiologyContent = {
  ...
  resources: [
    ...
    },
    {
      ...
      type: "Book",
      description: "Contemporary Baptist perspective on ecclesiology.",
      affiliate: true,
      affiliateUrl: "https://amazon.com/dp/1433524597"
    },
    {
      title: "The Church: An Introduction to the Theology of the Church",
      author: "Hans Küng",
      url: "/resources/church-introduction-kung",
      type: "Book",
      description: "Comprehensive Catholic perspective on the church.",
      affiliate: true,
...
export default function EcclesiologyPage({ params }: PageProps) {
  return (
          ...
          {ecclesiologyContent.traditions.map((tradition, index) => (
            <Card key={index}>
              ...
              <CardContent>
                ...
                <div className="mt-4">
                  <h4 className="font-semibold mb-2">Ecclesial Structure:</h4>
                  <p className="text-slate-600 mb-4">{tradition.ecclesialStructure}</p>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <Link href={`/${params.locale}/christianity/christology`} className="block">
            <Card className="hover:bg-slate-50 transition-colors">
              ...
              <CardContent>
                <p>Explore Christ as the head of the Church.</p>
              </CardContent>
            </Card>
          </Link>
          <Link href={`/${params.locale}/christianity/theology/soteriology`} className="block">
            <Card className="hover:bg-slate-50 transition-colors">
              <CardHeader>
                <CardTitle>Soteriology</CardTitle>
              </CardHeader>
              <CardContent>
                <p>Understand salvation in the context of the Church.</p>
              </CardContent>
            </Card>
          </Link>
          <Link href={`/${params.locale}/christianity/history`} className="block">
            <Card className="hover:bg-slate-50 transition-colors">
              <CardHeader>
                <CardTitle>Church History</CardTitle>
              </CardHeader>
              <CardContent>
                <p>Learn about the historical development of the Church.</p>
              </CardContent>
            </Card>
          </Link>
        </div>
