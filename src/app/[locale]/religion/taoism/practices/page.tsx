...
export const metadata: Metadata = {
  title: 'Practices | Taoism',
  description: 'Taoist practices and rituals',
  keywords: 'Taoism, practices, taoism practices',
  openGraph: {
    title: 'Practices | Taoism',
    description: 'Taoist practices and rituals',
    images: [{ url: '/images/taoism-practices.jpg', width: 1200, height: 630 }]
  }
}
...
export default function TaoismPracticesPage({ params }: PageProps) {
  return (
    <div className="container mx-auto px-4 py-8 space-y-12">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Practices in Taoism</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          <section className="space-y-4">
            <h3 className="text-xl font-semibold">Overview</h3>
            <p className="text-muted-foreground">
              This page provides comprehensive information about practices in the context of taoism. 
