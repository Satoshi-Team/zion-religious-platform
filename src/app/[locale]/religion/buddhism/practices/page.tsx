...
export const metadata: Metadata = {
  title: 'Practices | Buddhism',
  description: 'Buddhist religious practices and meditation',
  keywords: 'Buddhism, practices, buddhism practices',
  openGraph: {
    title: 'Practices | Buddhism',
    description: 'Buddhist religious practices and meditation',
    images: [{ url: '/images/buddhism-practices.jpg', width: 1200, height: 630 }]
  }
}
...
export default function BuddhismPracticesPage({ params }: PageProps) {
  return (
    <div className="container mx-auto px-4 py-8 space-y-12">
      <section className="space-y-6">
        ...
        <p className="text-sm text-muted-foreground">Locale: {params.locale}</p>
          Buddhist religious practices and meditation
        </p>
      </section>

      <Card>
        <CardHeader>
          <CardTitle>Practices in Buddhism</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          <section className="space-y-4">
            <h3 className="text-xl font-semibold">Overview</h3>
            <p className="text-muted-foreground">
              This page provides comprehensive information about practices in the context of buddhism. 
