...
export const metadata: Metadata = {
  title: 'Practices | Sikhism',
  description: 'Sikh religious practices and rituals',
  keywords: 'Sikhism, practices, sikhism practices',
  openGraph: {
    title: 'Practices | Sikhism',
    description: 'Sikh religious practices and rituals',
    images: [{ url: '/images/sikhism-practices.jpg', width: 1200, height: 630 }]
  }
}
...
export default function SikhismPracticesPage({ params }: PageProps) {
  return (
    <div className="container mx-auto px-4 py-8 space-y-12">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Practices in Sikhism</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          <section className="space-y-4">
            <h3 className="text-xl font-semibold">Overview</h3>
            <p className="text-muted-foreground">
              This page provides comprehensive information about practices in the context of sikhism. 
