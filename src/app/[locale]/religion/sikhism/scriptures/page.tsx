...
export const metadata: Metadata = {
  title: 'Scriptures | Sikhism',
  description: 'Sacred texts and scriptures of Sikhism',
  keywords: 'Sikhism, scriptures, sikhism scriptures',
  openGraph: {
    title: 'Scriptures | Sikhism',
    description: 'Sacred texts and scriptures of Sikhism',
    images: [{ url: '/images/sikhism-scriptures.jpg', width: 1200, height: 630 }]
  }
}
...
export default function SikhismScripturesPage({ params }: PageProps) {
  return (
    <div className="container mx-auto px-4 py-8 space-y-12">
      <section className="space-y-6">
        ...
        <p className="text-sm text-muted-foreground">Locale: {params.locale}</p>
          Sacred texts and scriptures of Sikhism
        </p>
      </section>

      <Card>
        <CardHeader>
          <CardTitle>Scriptures in Sikhism</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          <section className="space-y-4">
            <h3 className="text-xl font-semibold">Overview</h3>
            <p className="text-muted-foreground">
              This page provides comprehensive information about scriptures in the context of sikhism. 
