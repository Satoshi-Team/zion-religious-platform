...
export const metadata: Metadata = {
  title: 'Practices | Bahai',
  description: 'Bahá\'í practices and rituals',
  keywords: 'Bahai, practices, bahai practices',
  openGraph: {
    title: 'Practices | Bahai',
    description: 'Bahá\'í practices and rituals',
    images: [{ url: '/images/bahai-practices.jpg', width: 1200, height: 630 }]
  }
}
...
export default function BahaiPracticesPage({ params }: PageProps) {
  return (
    <div className="container mx-auto px-4 py-8 space-y-12">
      <section className="space-y-6">
        ...
        <p className="text-sm text-muted-foreground">Locale: {params.locale}</p>
          Bahá'í practices and rituals
        </p>
      </section>

      <Card>
        <CardHeader>
          <CardTitle>Practices in Bahai</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          <section className="space-y-4">
            <h3 className="text-xl font-semibold">Overview</h3>
            <p className="text-muted-foreground">
              This page provides comprehensive information about practices in the context of bahai. 
