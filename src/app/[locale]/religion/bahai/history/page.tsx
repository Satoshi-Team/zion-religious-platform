...
export const metadata: Metadata = {
  title: 'History | Bahai',
  description: 'The historical development of the Bahá\'í Faith',
  keywords: 'Bahai, history, bahai history',
  openGraph: {
    title: 'History | Bahai',
    description: 'The historical development of the Bahá\'í Faith',
    images: [{ url: '/images/bahai-history.jpg', width: 1200, height: 630 }]
  }
}
...
export default function BahaiHistoryPage({ params }: PageProps) {
  return (
    <div className="container mx-auto px-4 py-8 space-y-12">
      ...
      <Card>
        <CardHeader>
          <CardTitle>History in Bahai</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          <section className="space-y-4">
            <h3 className="text-xl font-semibold">Overview</h3>
            <p className="text-muted-foreground">
              This page provides comprehensive information about history in the context of bahai. 
