...
export const metadata: Metadata = {
  title: 'Practices | Shinto',
  description: 'Shinto practices and rituals',
  keywords: 'Shinto, practices, shinto practices',
  openGraph: {
    title: 'Practices | Shinto',
    description: 'Shinto practices and rituals',
    images: [{ url: '/images/shinto-practices.jpg', width: 1200, height: 630 }]
  }
}
...
export default function ShintoPracticesPage({ params }: PageProps) {
  return (
    <div className="container mx-auto px-4 py-8 space-y-12">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Practices in Shinto</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          <section className="space-y-4">
            <h3 className="text-xl font-semibold">Overview</h3>
            <p className="text-muted-foreground">
              This page provides comprehensive information about practices in the context of shinto. 
