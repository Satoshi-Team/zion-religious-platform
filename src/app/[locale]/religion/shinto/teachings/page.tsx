...
export const metadata: Metadata = {
  title: 'Teachings | Shinto',
  description: 'Core teachings and principles of Shinto',
  keywords: 'Shinto, teachings, shinto teachings',
  openGraph: {
    title: 'Teachings | Shinto',
    description: 'Core teachings and principles of Shinto',
    images: [{ url: '/images/shinto-teachings.jpg', width: 1200, height: 630 }]
  }
}
...
export default function ShintoTeachingsPage({ params }: PageProps) {
  return (
    <div className="container mx-auto px-4 py-8 space-y-12">
      <section className="space-y-6">
        ...
        <p className="text-sm text-muted-foreground">Locale: {params.locale}</p>
          Core teachings and principles of Shinto
        </p>
      </section>

      <Card>
        <CardHeader>
          <CardTitle>Teachings in Shinto</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          <section className="space-y-4">
            <h3 className="text-xl font-semibold">Overview</h3>
            <p className="text-muted-foreground">
              This page provides comprehensive information about teachings in the context of shinto. 
