...
export const metadata: Metadata = {
  title: 'History | Judaism',
  description: 'The historical development of Judaism',
  keywords: 'Judaism, history, judaism history',
  openGraph: {
    title: 'History | Judaism',
    description: 'The historical development of Judaism',
    images: [{ url: '/images/judaism-history.jpg', width: 1200, height: 630 }]
  }
}
...
export default function JudaismHistoryPage({ params }: PageProps) {
  return (
    <div className="container mx-auto px-4 py-8 space-y-12">
      ...
      <Card>
        <CardHeader>
          <CardTitle>History in Judaism</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          <section className="space-y-4">
            <h3 className="text-xl font-semibold">Overview</h3>
            <p className="text-muted-foreground">
              This page provides comprehensive information about history in the context of judaism. 
