...
export const metadata: Metadata = {
  title: 'Scriptures | Judaism',
  description: 'Sacred texts and scriptures of Judaism',
  keywords: 'Judaism, scriptures, judaism scriptures',
  openGraph: {
    title: 'Scriptures | Judaism',
    description: 'Sacred texts and scriptures of Judaism',
    images: [{ url: '/images/judaism-scriptures.jpg', width: 1200, height: 630 }]
  }
}
...
export default function JudaismScripturesPage({ params }: PageProps) {
  return (
    <div className="container mx-auto px-4 py-8 space-y-12">
      <section className="space-y-6">
        ...
        <p className="text-sm text-muted-foreground">Locale: {params.locale}</p>
          Sacred texts and scriptures of Judaism
        </p>
      </section>

      <Card>
        <CardHeader>
          <CardTitle>Scriptures in Judaism</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          <section className="space-y-4">
            <h3 className="text-xl font-semibold">Overview</h3>
            <p className="text-muted-foreground">
              This page provides comprehensive information about scriptures in the context of judaism. 
