...
export const metadata: Metadata = {
  title: 'Deities | Hinduism',
  description: 'Major Hindu deities and their significance',
  keywords: 'Hinduism, deities, hinduism deities',
  openGraph: {
    title: 'Deities | Hinduism',
    description: 'Major Hindu deities and their significance',
    images: [{ url: '/images/hinduism-deities.jpg', width: 1200, height: 630 }]
  }
}
...
export default function HinduismDeitiesPage({ params }: PageProps) {
  return (
    <div className="container mx-auto px-4 py-8 space-y-12">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Deities in Hinduism</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          <section className="space-y-4">
            <h3 className="text-xl font-semibold">Overview</h3>
            <p className="text-muted-foreground">
              This page provides comprehensive information about deities in the context of hinduism. 
