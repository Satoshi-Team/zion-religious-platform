...
export async function generateMetadata({ params }: ChapterPageProps): Promise<Metadata> {
  ...
  return {
    title: `Song of Solomon ${params.chapter} - Bible | ZION.FM`,
    description: "Explore sacred scriptures from various religions",
    keywords: ["Bible", "Song of Solomon", "Sacred Texts", "Christianity"],
    openGraph: {
      title: `Song of Solomon ${params.chapter} - Bible`,
      description: "Explore sacred scriptures from various religions",
      type: 'website',
    },
  }
    ...
    <div className="container mx-auto px-4 py-8">
      <nav className="mb-6">
        <ol className="flex items-center space-x-2 text-sm text-muted-foreground">
          ...
          <li>/</li>
          <li>
            <Link href={`/${params.locale}/sacred-texts/bible/song-of-solomon`} className="hover:text-foreground">
              Song of Solomon
            </Link>
          </li>
          <li>/</li>
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          <Link href={`/${params.locale}/sacred-texts/bible/song-of-solomon`}>
        ...
        <div className="space-y-4">
          <h1 className="text-4xl font-bold tracking-tight">
            Song of Solomon Chapter {chapterNumber}
          </h1>
            ...
            {error ? (
              <div className="space-y-4">
                  ...
                  <div key={2} className="flex gap-4">
                    ...
                    <p className="flex-1 leading-relaxed">
                      The woman said to the serpent, "From the fruit of the trees we may eat."
                    </p>
                  </div>
                  <div key={3} className="flex gap-4">
                    ...
                    <p className="flex-1 leading-relaxed">
                      But from the fruit of the tree in the middle, God has said, 'You shall not eat.'
                    </p>
                  </div>
              </div>
            )}
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          {chapterNumber > 1 && (
            <Link href={`/${params.locale}/sacred-texts/bible/song-of-solomon/${chapterNumber - 1}`}>
