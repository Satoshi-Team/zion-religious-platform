...
export async function generateMetadata({ params }: BookPageProps): Promise<Metadata> {
  ...
  return {
    title: `1 timothy - Bible | ${'ZION.FM' || 'ZION.FM'}`,
    description: 'Explore sacred scriptures from various religions' || 'Explore sacred scriptures from various religions',
    keywords: ['Bible', '1 timothy', 'Sacred Texts' || 'Sacred Texts', 'Christianity'],
    openGraph: {
      title: `1 timothy - Bible`,
      description: 'Explore sacred scriptures from various religions' || 'Explore sacred scriptures from various religions',
      type: 'website',
    },
  }
    ...
    <div className="container mx-auto px-4 py-8">
      <nav className="mb-6">
        <ol className="flex items-center space-x-2 text-sm text-muted-foreground">
          ...
          <li>/</li>
          <li className="text-foreground font-medium">1 Timothy</li>
        </ol>
      </nav>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-4">
          <h1 className="text-4xl font-bold tracking-tight">1 Timothy</h1>
          <div className="flex flex-wrap gap-4 text-sm text-muted-foreground">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>Pastoral Epistles</span>
            </div>
            <div className="flex items-center gap-2">
              <Calendar className="h-4 w-4" />
              <span>Chapters: 6</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <Card className="mb-8">
        ...
        <CardContent>
          <div className="prose prose-sm max-w-none">
            <p>
              The First Letter to Timothy provides instructions for church leadership and conduct, emphasizing sound doctrine and godly living.
            </p>
          </div>
        </CardContent>
      </Card>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
            {chapters.map((chapter) => (
              <Link key={chapter} href={`/${params.locale}/sacred-texts/bible/1-timothy/${chapter}`}>
