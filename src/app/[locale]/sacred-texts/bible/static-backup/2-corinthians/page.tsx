...
export async function generateMetadata({ params }: BookPageProps): Promise<Metadata> {
  ...
  return {
    title: `2 corinthians - Bible | ${'ZION.FM' || 'ZION.FM'}`,
    description: 'Explore sacred scriptures from various religions' || 'Explore sacred scriptures from various religions',
    keywords: ['Bible', '2 corinthians', 'Sacred Texts' || 'Sacred Texts', 'Christianity'],
    openGraph: {
      title: `2 corinthians - Bible`,
      description: 'Explore sacred scriptures from various religions' || 'Explore sacred scriptures from various religions',
      type: 'website',
    },
  }
    ...
    <div className="container mx-auto px-4 py-8">
      <nav className="mb-6">
        <ol className="flex items-center space-x-2 text-sm text-muted-foreground">
          ...
          <li>/</li>
          <li className="text-foreground font-medium">2 Corinthians</li>
        </ol>
      </nav>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-4">
          <h1 className="text-4xl font-bold tracking-tight">2 Corinthians</h1>
      ...
      <Card className="mb-8">
        ...
        <CardContent>
          <div className="prose prose-sm max-w-none">
            <p>
              The Second Letter to the Corinthians defends Paul's apostolic authority and ministry, emphasizing the power of God working through human weakness.
            </p>
          </div>
        </CardContent>
      </Card>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
            {chapters.map((chapter) => (
              <Link key={chapter} href={`/${params.locale}/sacred-texts/bible/2-corinthians/${chapter}`}>
