    ...
    <div className="container mx-auto px-4 py-8">
      <nav className="mb-6">
        <ol className="flex items-center space-x-2 text-sm text-muted-foreground">
          ...
          <li>/</li>
          <li className="text-foreground font-medium">Isaiah</li>
        </ol>
      </nav>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-4">
          <h1 className="text-4xl font-bold tracking-tight">Isaiah</h1>
      ...
      <Card className="mb-8">
        ...
        <CardContent>
          <div className="prose prose-sm max-w-none">
            <p>
              The Book of Isaiah contains prophecies about judgment and restoration, including many messianic prophecies that point to Jesus Christ.
            </p>
          </div>
        </CardContent>
      </Card>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
            {chapters.map((chapter) => (
              <Link key={chapter} href={`/${params.locale}/sacred-texts/bible/isaiah/${chapter}`}>
