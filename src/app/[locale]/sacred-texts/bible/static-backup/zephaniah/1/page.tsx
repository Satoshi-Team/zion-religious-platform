...
export async function generateMetadata({ params }: ChapterPageProps): Promise<Metadata> {
  ...
  return {
    title: `Zephaniah ${params.chapter} - Bible | ZION.FM`,
    description: "Explore sacred scriptures from various religions",
    keywords: ["Bible", "Zephaniah", "Sacred Texts", "Christianity"],
    openGraph: {
      title: `Zephaniah ${params.chapter} - Bible`,
      description: "Explore sacred scriptures from various religions",
      type: 'website',
    },
  }
    ...
    <div className="container mx-auto px-4 py-8">
      <nav className="mb-6">
        <ol className="flex items-center space-x-2 text-sm text-muted-foreground">
          ...
          <li>/</li>
          <li>
            <Link href={`/${params.locale}/sacred-texts/bible/zephaniah`} className="hover:text-foreground">
              Zephaniah
            </Link>
          </li>
          <li>/</li>
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          <Link href={`/${params.locale}/sacred-texts/bible/zephaniah`}>
        ...
        <div className="space-y-4">
          <h1 className="text-4xl font-bold tracking-tight">
            Zephaniah Chapter {chapterNumber}
          </h1>
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          {chapterNumber > 1 && (
            <Link href={`/${params.locale}/sacred-texts/bible/zephaniah/${chapterNumber - 1}`}>
