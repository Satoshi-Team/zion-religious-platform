...
export default async function BookPage({ params }: BookPageProps) {
  ...
  const chapters = Array.from({ length: 48 }, (_, i) => i + 1)
    ...
    <div className="container mx-auto px-4 py-8">
      <nav className="mb-6">
        <ol className="flex items-center space-x-2 text-sm text-muted-foreground">
          ...
          <li>/</li>
          <li className="text-foreground font-medium">Ezekiel</li>
        </ol>
      </nav>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-4">
          <h1 className="text-4xl font-bold tracking-tight">Ezekiel</h1>
      ...
      <Card className="mb-8">
        ...
        <CardContent>
          <div className="prose prose-sm max-w-none">
            <p>
              The Book of Ezekiel is one of the major prophetic books of the Old Testament. 
              Ezekiel, a priest and prophet, was taken into Babylonian captivity and received 
              visions and prophecies concerning the judgment of Jerusalem, the restoration of Israel, 
        ...
        <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
            {chapters.map((chapter) => (
              <Link key={chapter} href={`/${params.locale}/sacred-texts/bible/ezekiel/${chapter}`}>
