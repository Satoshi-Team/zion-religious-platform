...
export async function generateMetadata({ params }: ChapterPageProps): Promise<Metadata> {
  ...
  return {
    title: `Zechariah ${params.chapter} - Bible | ZION.FM`,
    description: "Explore sacred scriptures from various religions",
    keywords: ["Bible", "Zechariah", "Sacred Texts", "Christianity"],
    openGraph: {
      title: `Zechariah ${params.chapter} - Bible`,
      description: "Explore sacred scriptures from various religions",
      type: 'website',
    },
  }
    ...
    <div className="container mx-auto px-4 py-8">
      <nav className="mb-6">
        <ol className="flex items-center space-x-2 text-sm text-muted-foreground">
          ...
          <li>/</li>
          <li>
            <Link href={`/${params.locale}/sacred-texts/bible/zechariah`} className="hover:text-foreground">
              Zechariah
            </Link>
          </li>
          <li>/</li>
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          <Link href={`/${params.locale}/sacred-texts/bible/zechariah`}>
        ...
        <div className="space-y-4">
          <h1 className="text-4xl font-bold tracking-tight">
            Zechariah Chapter {chapterNumber}
          </h1>
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          {chapterNumber > 1 && (
            <Link href={`/${params.locale}/sacred-texts/bible/zechariah/${chapterNumber - 1}`}>
