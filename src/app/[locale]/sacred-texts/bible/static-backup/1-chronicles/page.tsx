...
export async function generateMetadata({ params }: BookPageProps): Promise<Metadata> {
  ...
  return {
    title: `1 chronicles - Bible | ${'ZION.FM' || 'ZION.FM'}`,
    description: 'Explore sacred scriptures from various religions' || 'Explore sacred scriptures from various religions',
    keywords: ['Bible', '1 chronicles', 'Sacred Texts' || 'Sacred Texts', 'Christianity'],
    openGraph: {
      title: `1 chronicles - Bible`,
      description: 'Explore sacred scriptures from various religions' || 'Explore sacred scriptures from various religions',
      type: 'website',
    },
  }
...
export default async function BookPage({ params }: BookPageProps) {
  ...
  const chapters = Array.from({ length: 29 }, (_, i) => i + 1)
    ...
    <div className="container mx-auto px-4 py-8">
      <nav className="mb-6">
        <ol className="flex items-center space-x-2 text-sm text-muted-foreground">
          ...
          <li>/</li>
          <li className="text-foreground font-medium">1 Chronicles</li>
        </ol>
      </nav>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-4">
          <h1 className="text-4xl font-bold tracking-tight">1 Chronicles</h1>
      ...
      <Card className="mb-8">
        ...
        <CardContent>
          <div className="prose prose-sm max-w-none">
            <p>
              The First Book of Chronicles provides a genealogical and historical overview of Israel from Adam through David, emphasizing the Davidic dynasty and the temple.
            </p>
          </div>
        </CardContent>
      </Card>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
            {chapters.map((chapter) => (
              <Link key={chapter} href={`/${params.locale}/sacred-texts/bible/1-chronicles/${chapter}`}>
