...
export async function generateMetadata({ params }: ChapterPageProps): Promise<Metadata> {
  ...
  return {
    title: `1 Samuel ${params.chapter} - Bible | ZION.FM`,
    description: "Explore sacred scriptures from various religions",
    keywords: ["Bible", "1 Samuel", "Sacred Texts", "Christianity"],
    openGraph: {
      title: `1 Samuel ${params.chapter} - Bible`,
      description: "Explore sacred scriptures from various religions",
      type: 'website',
    },
  }
...
export default async function ChapterPage({ params }: ChapterPageProps) {
  ...
  console.log('params.chapter:', params.chapter, 'type:', typeof params.chapter)
  
  const chapterNumber = parseInt(params.chapter, 10)
  
  console.log('Parsed chapterNumber:', chapterNumber, 'isNaN:', isNaN(chapterNumber))
  
  // Validate chapter number
  if (isNaN(chapterNumber) || chapterNumber < 1) {
    console.error('Invalid chapter number:', params.chapter)
    return (
    ...
    <div className="container mx-auto px-4 py-8">
      <nav className="mb-6">
        <ol className="flex items-center space-x-2 text-sm text-muted-foreground">
          ...
          <li>/</li>
          <li>
            <Link href={`/${params.locale}/sacred-texts/bible/1-samuel`} className="hover:text-foreground">
              1 Samuel
            </Link>
          </li>
          <li>/</li>
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          <Link href={`/${params.locale}/sacred-texts/bible/1-samuel`}>
        ...
        <div className="space-y-4">
          <h1 className="text-4xl font-bold tracking-tight">
            1 Samuel Chapter {chapterNumber}
          </h1>
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          {chapterNumber > 1 && (
            <Link href={`/${params.locale}/sacred-texts/bible/1-samuel/${chapterNumber - 1}`}>
