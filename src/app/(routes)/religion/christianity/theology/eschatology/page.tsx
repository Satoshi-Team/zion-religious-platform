...
const eschatologyContent: EschatologyContent = {
  ...
  resources: [
    {
      title: "The Meaning of the Millennium",
      author: "Robert G. Clouse",
      url: "/resources/millennium-clouse",
      type: "Book",
      description: "Four views on the millennium with responses.",
      affiliate: true,
      affiliateUrl: "https://amazon.com/dp/0877847940"
    },
    {
      title: "Three Views on the Rapture",
      author: "Craig A. Blaising",
      url: "/resources/rapture-views",
      type: "Book",
      description: "Pre-, mid-, and post-tribulation perspectives.",
      affiliate: true,
      affiliateUrl: "https://amazon.com/dp/0310277200"
    },
    {
      title: "Heaven",
      author: "Randy Alcorn",
      url: "/resources/heaven-alcorn",
      type: "Book",
      description: "Biblical teaching on eternal life and new creation.",
      affiliate: true,
      affiliateUrl: "https://amazon.com/dp/0842379428"
    }
  ]
}
...
export default function EschatologyPage() {
  return (
    <div className="container mx-auto px-4 py-8 space-y-12">
      ...
      <section className="space-y-6">
        <h2 className="text-3xl font-bold mb-4">Millennial Views</h2>
          ...
          {eschatologyContent.events.map((event, index) => (
            <Card key={index}>
              ...
              <CardContent>
                ...
                <p className="mt-4 text-sm text-slate-600">Scripture: {event.scriptureRef}</p>
              </CardContent>
            </Card>
          ))}
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <Link href="/religion/christianity/theology/soteriology" className="block">
            <Card className="hover:bg-slate-50 transition-colors">
              ...
              <CardContent>
                <p>Explore salvation's completion in end times.</p>
              </CardContent>
            </Card>
          </Link>
          <Link href="/religion/christianity/theology/christology" className="block">
            <Card className="hover:bg-slate-50 transition-colors">
              ...
              <CardContent>
                <p>Understand Christ's role in final events.</p>
              </CardContent>
            </Card>
          </Link>
          <Link href="/religion/christianity/theology/ecclesiology" className="block">
            <Card className="hover:bg-slate-50 transition-colors">
              ...
              <CardContent>
                <p>Learn about the Church's future hope.</p>
              </CardContent>
            </Card>
          </Link>
        </div>
