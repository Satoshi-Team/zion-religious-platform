    ...
    <div className="container mx-auto px-4 py-8 space-y-12">
      ...
      <section className="mt-12">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <Link href="/teachings/christianity/christology" className="block">
          ...
          <Link href="/teachings/christianity/pneumatology" className="block">
            <Card className="hover:bg-slate-50 transition-colors">
              <CardHeader>
          ...
          <Link href="/teachings/christianity/ecclesiology" className="block">
            <Card className="hover:bg-slate-50 transition-colors">
              <CardHeader>
